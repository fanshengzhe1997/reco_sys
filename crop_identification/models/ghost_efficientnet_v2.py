...
#
#   Project     : 
#   File name   : ghost_efficientnet_v2.py
#   Author      : Fan Shengzhe
...
def base(cfg, num_class=1000, input_tensor=None, activation=activations.swish,
    ...
    :param num_class: number of classes to output
...
def get_ghost_efficientnet_v2_s(in_shape=(224, 224, 3), num_class=1000, input_tensor=None, activation=activations.swish,
      width_mult=1., depth_mult=1., conv_dropout_rate=None, dropout_rate=None, drop_connect=.2):
    """
        EfficientNet-V2-s, re-implementation according to
        https://arxiv.org/abs/2104.00298
    ...
    return base(cfg=cfg, num_class=num_class, input_tensor=input_tensor, activation=activation,
...
def get_ghost_efficientnet_v2_m(in_shape=(224, 224, 3), num_class=1000, input_tensor=None, activation=activations.swish,
...
def get_ghost_efficientnet_v2_l(in_shape=(224, 224, 3), num_class=1000, input_tensor=None, activation=activations.swish,
      width_mult=1.0, depth_mult=1., conv_dropout_rate=None, dropout_rate=None, drop_connect=.2):
    """
...
def get_ghost_efficientnet_v2_xl(in_shape=(224, 224, 3), num_class=1000, input_tensor=None, activation=activations.swish,
      width_mult=1.0, depth_mult=1., conv_dropout_rate=None, dropout_rate=None, drop_connect=.2):
    """
